...
public interface IPDFCore
{
    ...
    string BuildMergedPdfContent(string[] mergedObjects, PDFConfig config);
}
...
public class PDFCore : IPDFCore
{
    ...
    public string BuildMergedPdfContent(string[] mergedObjects, PDFConfig config)
    {
        var pdf = new StringBuilder();
        
        // Cabecera con metadatos
        pdf.Append(BuildPdfHeader(config));

        // Calcula offsets
        int[] offsets = CalculateOffsets(mergedObjects);
        ...
        pdf.Append(BuildXrefTable(mergedObjects, offsets));

        // trailer con metadatos
        pdf.Append(BuildTrailer(mergedObjects.Length, xrefPosition, config));
